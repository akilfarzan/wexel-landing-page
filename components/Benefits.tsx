      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-gray-600">The Wexel Solution</p>
          </motion.div>
        </div>
        ...
        <div className="space-y-5">
          {scenarios.map((scenario, index) => (
            ...
            >
              ...
              {/* After */}
              <div className="group relative">
                <div className="h-full p-4 sm:p-6 bg-white rounded-2xl shadow-lg border-2 border-green-100 hover:shadow-xl transition-all duration-300 hover:border-green-200">
                  <div className="flex items-start space-x-2 sm:space-x-4">
