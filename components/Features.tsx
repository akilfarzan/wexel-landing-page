...
const features = [
  ...
  },
  {
    ...
    description: 'No more manual emails. Generate invoices, emails and reminders like clockwork, right from your Wexel app., job updates, and reminders go out like clockwork. Stay professional — without lifting a finger.',
